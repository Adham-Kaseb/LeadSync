...
export async function renderDashboard() {
  ...
  try {
              ...
              lastMessage
                ? `
                    <div style="background: rgba(0,0,0,0.3); padding: 1rem; border-radius: 8px;">
                        <h4 style="color: var(--metallic-gold); margin-bottom: 0.5rem;">${
                    ...
                    (lastMessage.body || "").length > 100 ? "..." : ""
                        ...
                        <div style="margin-top: 0.8rem; font-size: 0.8rem; opacity: 0.7;">
                            <i class="fa-solid fa-feather"></i> ${Utils.formatDate(
      ...
      actionCard.querySelector(".edit-actions-btn").onclick = () => {
        ...
        modal.innerHTML = `
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; flex:1; overflow-y:auto; padding-right:5px;">
                        ${Object.keys(allPossibleActions)
                          .map(
                            (key) => `
                            <div class="action-toggle-item ${
    ...
    const renderSalesCard = () => {
      ...
      const yesterday = data.yesterday || { totalEgp: "---" };
      ...
      salesCard.innerHTML = `
                ...
                <div class="dashboard-sales-grid">
                    ...
                    <div class="dashboard-sales-item">
                        <span class="dash-sales-label">مبيعات الأمس</span>
                        <span class="dash-sales-value">${
                          yesterday.totalEgp
                        }</span>
                    </div>
                </div>
                ...
                <div style="margin-top: 1.2rem; display: flex; gap: 0.8rem;">
                    <div style="flex:1; background:rgba(255,215,0,0.05); padding:10px; border-radius:12px; border:1px solid rgba(255,215,0,0.1); text-align:center;">
                        ...
                        <div style="font-size:1.1rem; font-weight:700; color:var(--metallic-gold);">${
                          today.orders
                        }</div>
                    </div>
      ...
      if (timeEl)
        timeEl.innerText = `${isOldUI ? "مخزنة: " : "مباشر: "}${timeStr}`;
          ...
          if (freqData) {
            ...
            for (let i = 0; i < barCount; i++) {
              ...
              if (bar) {
                ...
                bar.style.filter = `hue-rotate(${hueShift}deg) brightness(${
